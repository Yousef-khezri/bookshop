...
// 	const [gender, setGender] = useState("none");
// 	const [phone, setPhone] = useState("");
// 	const [urlImage, setUrlImage] = useState("/images/noneGender.png");
// 	const [email, setEmail] = useState("");
// 	const [password, setPassword] = useState("");
// 	const [username, setUsername] = useState("");
// 	const [errorMessage, setErrorMessage] = useState("");
...
// 		);
// 		if (user) {
// 			updateCheckLogin( user );
// 			navigate("/");
// 		} else {
// 			setErrorMessage("Sorry, I don't find...");
// 		}
// 	};
...
// 		const highestId = userList.reduce(
...
// 				<div className="form-box login">
// 					<h2>Login</h2>
// 					<form action="#" onSubmit={clickedLogin}>
// 						<div className="input-box input-box-email">
// 							<span className="icon">
// 								<div className="icon-email"></div>
// 							</span>
